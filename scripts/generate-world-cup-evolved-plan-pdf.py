...
PDF_NAME = "world-cup-toto-1634-1637-evolved-plan-20260625-v19.pdf"
CSV_50_NAME = "world-cup-toto-1637-visual-5000-plan-20260625-v19.csv"
CSV_NAME = "world-cup-toto-1637-visual-10000-plan-20260625-v19.csv"
CSV_200_NAME = "world-cup-toto-1637-visual-20000-plan-20260625-v19.csv"
PDF_ALIASES = (
    PDF_NAME,
...
SNAPSHOT_1637_VOTE_LABEL = "2026-06-25 17:37 JST"
SNAPSHOT_1637_SALES_LABEL = "2026-06-25 17:37 JST"
TOTAL_SALES_1637_YEN = 298_465_800
VOTE_UNITS_1637 = 2_984_658
RETURN_RATE = 0.5
TIER_DEFS = (
    ("1等", 0, 0.70, True),
    ("2等", 1, 0.15, False),
...
MATCHES_1637 = [
    PlanMatch(1, "エクアドル", "ドイツ", "06/26 05:00", (0.0875, 0.1640, 0.7485), ("2", "0"), "強豪人気 + 第3戦ドロー", "semi"),
    PlanMatch(2, "日本", "スウェーデン", "06/26 08:00", (0.6578, 0.2389, 0.1033), ("1", "0"), "日本勝ち軸 + ドロー", "flex"),
    PlanMatch(3, "ウルグアイ", "スペイン", "06/27 09:00", (0.0709, 0.2012, 0.7279), ("2", "0"), "スペイン軸 + 条件戦ドロー", "semi"),
    PlanMatch(4, "コロンビア", "ポルトガル", "06/28 08:30", (0.2228, 0.3198, 0.4574), ("2", "0", "1"), "30%台を全分散", "spread"),
    PlanMatch(5, "アルジェリア", "オーストリア", "06/28 11:00", (0.2026, 0.3266, 0.4708), ("0", "2"), "ドロー上振れ + オーストリア軸", "flex"),
    PlanMatch(6, "チュニジア", "オランダ", "06/26 08:00", (0.0222, 0.0418, 0.9360), ("2", "0"), "90%超人気 + 薄いドロー", "semi"),
    PlanMatch(7, "パラグアイ", "オーストラリア", "06/26 11:00", (0.3137, 0.3439, 0.3424), ("1", "0", "2"), "ほぼ三分で全分散", "spread"),
    PlanMatch(8, "ノルウェー", "フランス", "06/27 04:00", (0.1262, 0.2359, 0.6379), ("2", "0"), "フランス軸 + 条件戦ドロー", "semi"),
    PlanMatch(9, "パナマ", "イングランド", "06/28 06:00", (0.0229, 0.0640, 0.9131), ("2",), "補正ありでも勝ち固定", "lock"),
    PlanMatch(10, "コンゴ民主共和国", "ウズベキスタン", "06/28 08:30", (0.5389, 0.2943, 0.1668), ("1", "0", "2"), "30%台に散る全分散", "spread"),
    PlanMatch(11, "ヨルダン", "アルゼンチン", "06/28 11:00", (0.0227, 0.0508, 0.9265), ("2",), "補正ありでも勝ち固定", "lock"),
    PlanMatch(12, "ニュージーランド", "ベルギー", "06/27 12:00", (0.0432, 0.1311, 0.8257), ("2", "0"), "強豪人気 + 薄いドロー", "semi"),
    PlanMatch(13, "クロアチア", "ガーナ", "06/28 06:00", (0.5955, 0.2738, 0.1307), ("1", "0"), "クロアチア軸 + 条件戦ドロー", "semi"),
]
...
POLYMARKET_1637_ROWS = [
    {
        "no": 1,
        "market": (0.1633, 0.1735, 0.6633),
        "delta": (0.0758, 0.0095, -0.0852),
        "volume": 4_302_010,
    ...
    {
        "no": 2,
        "market": (0.5300, 0.2600, 0.2100),
        "delta": (-0.1278, 0.0211, 0.1067),
        "volume": 1_187_975,
    ...
    {
        "no": 3,
        "market": (0.1212, 0.2222, 0.6566),
        "delta": (0.0503, 0.0210, -0.0713),
        "volume": 198_935,
    ...
    {
        "no": 4,
        "market": (0.2323, 0.2424, 0.5253),
        "delta": (0.0095, -0.0774, 0.0679),
        "volume": 255_690,
    ...
    {
        "no": 5,
        "market": (0.2347, 0.4286, 0.3367),
        "delta": (0.0321, 0.1020, -0.1341),
        "volume": 156_847,
    ...
    {
        "no": 6,
        "market": (0.0300, 0.0800, 0.8900),
        "delta": (0.0078, 0.0382, -0.0460),
        "volume": 1_130_906,
    ...
    {
        "no": 7,
        "market": (0.3434, 0.4242, 0.2323),
        "delta": (0.0297, 0.0803, -0.1101),
        "volume": 553_168,
    ...
    {
        "no": 8,
        "market": (0.1919, 0.2020, 0.6061),
        "delta": (0.0657, -0.0339, -0.0318),
        "volume": 438_174,
    ...
    {
        "no": 9,
        "market": (0.0505, 0.1111, 0.8384),
        "delta": (0.0276, 0.0471, -0.0747),
        "volume": 184_910,
    ...
    {
        "no": 12,
        "market": (0.0510, 0.1122, 0.8367),
        "delta": (0.0078, -0.0189, 0.0110),
        "volume": 303_604,
...
def budget_plan_summary_1637() -> Table:
    ...
    rows = [
        ...
        ["CSV", "latest-50/100/200-purchase-sheet は検算用に残す。latest-purchase-sheet は100口版の別名。v19ではPDFのマルチ表を主導線にする。"],
...
def polymarket_overlay_table_1637() -> Table:
    rows = [["No", "試合", "公式 1/0/2", "Polymarket 1/0/2", "最大+", "反映"]]
    ...
    result = table(rows, [10 * mm, 34 * mm, 29 * mm, 35 * mm, 18 * mm, 42 * mm])
    result.setStyle(TableStyle([("BACKGROUND", (0, 1), (0, -1), AMBER_LIGHT)]))
    return result
...
def final_lock_trigger_table_1637() -> Table:
    rows = [
        ...
        [
            "M13 Croatia-Ghana",
            "公式Croatia 59.8% / 市場Croatia 54.6%、Draw 29.3%。0を外さない。",
...
def final_logic_table_1637() -> Table:
    rows = [
        ...
        ["外部市場", "17:37公式と17:36 PolymarketではM05/M07のドロー、M02の日本人気、M13のドローを重視。M01全分散は下げる。"],
        ["暫定確定", "基本は市場補強108口=10,800円。M03ドローまで強く拾う場合だけ144口=14,400円。"],
        ["当日運用", "17:37版でPDFを更新済み。18:25に再取得できるなら最後に確認し、18:35-18:50に手入力。18:55以降は触らない。"],
    ]
    result = table(rows, [36 * mm, 132 * mm])
    result.setStyle(TableStyle([("BACKGROUND", (0, 1), (0, -1), TEAL_LIGHT)]))
    return result
...
def polymarket_backtest_audit_table() -> Table:
    rows = [
        ...
        ["1637", "2026-06-25 17:37公式投票率あり / 未開催", "2026-06-25 17:36時点のSports APIで13/13試合を照合済み", "前向き利用可。この17時台スナップショットを購入前検証の本線にする。"],
    ]
...
def build_pdf() -> Path:
    ...
    doc = SimpleDocTemplate(
        ...
        topMargin=12 * mm,
        bottomMargin=10 * mm,
        title="W杯toto 1634-1637 EV改善メモ v19",
    )

    story = [
        p("W杯toto 1634-1637 EV改善メモ v19", "title"),
        p("目的はシンプルです。1口いくらか、当たったらどれくらい戻るか、10口や1万円ならどの出目をどう置くか、そしてランダムよりEVが上がっているのかを見ます。"),
        p(f"1637の公式投票率は {SNAPSHOT_1637_VOTE_LABEL}、売上は {SNAPSHOT_1637_SALES_LABEL} 時点。現在売上は {yen(TOTAL_SALES_1637_YEN)}、投票数は {VOTE_UNITS_1637:,}口。latest PDFはこのv19へ差し替えます。", "small"),
        ...
        Spacer(1, 4 * mm),
        p("総当たりEVより上がったか", "h2"),
        p("結論: proxy上は上がっています。v19ではPolymarketの試合別1X2を再取得し、6/25 17:37公式投票率と比較しています。ただし、ブックメーカー複数社のvig除去やBetfair板はまだ未接続なので、真EVではなく外部市場proxyとして扱います。"),
        market_ev_table(),
        Spacer(1, 5 * mm),
        p("1637の最適戦略", "title"),
        ...
        Spacer(1, 4 * mm),
        p("出目を残すルール", "h2"),
        p(f"公式人気順だけなら {FAVORITE_1637}。ただし第3戦は中立地、国名人気、勝点条件、温存、引き分けOKで人気順からズレる余地があります。v19ではこの補正とPolymarket差分をマルチ選択の残し方に入れています。"),
        policy_table_1637(),
        Spacer(1, 4 * mm),
        p("マルチ指定の合計口数", "h2"),
        ...
        p("Haziコメントは無しとして、人間メモ重みは0にします。ここではPolymarketの公開Sports APIから取得できたW杯1X2価格をp_marketとして、toto公式投票率p_publicとの差を見ます。価格はSports APIの1X2価格を3出目合計100%へ正規化したものです。取得は2026-06-25 17:36 JST相当です。"),
        ...
        PageBreak(),
        p("1636旧シート先頭", "title"),
        p("1636では上位を厚くする案も試しましたが、v19の1637方針ではCSV行詳細よりマルチ選択表で口数と金額を確認します。"),
        hot_table(),
        Spacer(1, 4 * mm),
        p("なるべく自動で買う方法", "h2"),
        automation_table(),
