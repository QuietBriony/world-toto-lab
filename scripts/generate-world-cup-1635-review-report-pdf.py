...
MATCHES_1636 = [
    (1, "ドイツ", "コートジボワール", "06/21 05:00", (0.7125, 0.2123, 0.0752), ("1",), "70%超の勝ち固定"),
    (2, "チュニジア", "日本", "06/21 13:00", (0.0798, 0.2292, 0.6910), ("2", "0"), "日本勝ち軸+ドロー"),
    (3, "アルゼンチン", "オーストリア", "06/23 02:00", (0.7591, 0.1840, 0.0569), ("1",), "70%超の勝ち固定"),
    (4, "パナマ", "クロアチア", "06/24 08:00", (0.0428, 0.1325, 0.8247), ("2",), "80%超のアウェイ固定"),
    (5, "コロンビア", "コンゴ民主共和国", "06/24 11:00", (0.7060, 0.2264, 0.0676), ("1",), "70%超の勝ち固定"),
    (6, "オランダ", "スウェーデン", "06/21 02:00", (0.4985, 0.3152, 0.1863), ("1", "0", "2"), "割れる試合は全分散"),
    (7, "ウルグアイ", "カーボベルデ", "06/22 07:00", (0.7138, 0.2236, 0.0626), ("1",), "70%超の勝ち固定"),
    (8, "ノルウェー", "セネガル", "06/23 09:00", (0.4495, 0.2928, 0.2577), ("1", "0", "2"), "30%帯が散るので全分散"),
    (9, "ポルトガル", "ウズベキスタン", "06/24 02:00", (0.8075, 0.1492, 0.0433), ("1",), "80%超の勝ち固定"),
    (10, "ヨルダン", "アルジェリア", "06/23 12:00", (0.1496, 0.3319, 0.5185), ("2", "0"), "アウェイ勝ち軸+ドロー"),
    (11, "スペイン", "サウジアラビア", "06/22 01:00", (0.8381, 0.1246, 0.0373), ("1",), "80%超の勝ち固定"),
    (12, "イングランド", "ガーナ", "06/24 05:00", (0.8433, 0.1169, 0.0398), ("1",), "80%超の勝ち固定"),
    (13, "エクアドル", "キュラソー", "06/21 09:00", (0.8500, 0.1122, 0.0378), ("1",), "80%超の勝ち固定"),
]
...
def build_pdf() -> Path:
    ...
    story = [
        ...
        Spacer(1, 5 * mm),
        p("今回の前提", "h2"),
        p("第1635回は公式の販売終了時点投票と速報結果を突き合わせました。第1636回は2026-06-20 17:02時点の公式投票と、同日19:00締切を前提にしています。"),
