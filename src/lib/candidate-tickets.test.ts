...
function buildMatch(matchNo: number, overrides: Partial<Match> = {}): Match {
  ...
  return {
    ...
    recentFormNote: overrides.recentFormNote ?? null,
    availabilityInfo: overrides.availabilityInfo ?? null,
    conditionsInfo: overrides.conditionsInfo ?? null,
    homeStrengthAdjust: overrides.homeStrengthAdjust ?? null,
    awayStrengthAdjust: overrides.awayStrengthAdjust ?? null,
    availabilityAdjust: overrides.availabilityAdjust ?? null,
    conditionsAdjust: overrides.conditionsAdjust ?? null,
    tacticalAdjust: overrides.tacticalAdjust ?? null,
    motivationAdjust: overrides.motivationAdjust ?? null,
    adminAdjust1: overrides.adminAdjust1 ?? null,
    adminAdjust0: overrides.adminAdjust0 ?? null,
    adminAdjust2: overrides.adminAdjust2 ?? null,
    homeAdvantageAdjust: overrides.homeAdvantageAdjust ?? null,
    restDaysAdjust: overrides.restDaysAdjust ?? null,
    travelAdjust: overrides.travelAdjust ?? null,
    leagueTableMotivationAdjust: overrides.leagueTableMotivationAdjust ?? null,
    injurySuspensionAdjust: overrides.injurySuspensionAdjust ?? null,
    rotationRiskAdjust: overrides.rotationRiskAdjust ?? null,
    groupStandingMotivationAdjust: overrides.groupStandingMotivationAdjust ?? null,
    travelClimateAdjust: overrides.travelClimateAdjust ?? null,
    altitudeHumidityAdjust: overrides.altitudeHumidityAdjust ?? null,
    squadDepthAdjust: overrides.squadDepthAdjust ?? null,
    tournamentPressureAdjust: overrides.tournamentPressureAdjust ?? null,
